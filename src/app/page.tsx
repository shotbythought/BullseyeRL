...
export default function HomePage() {
  return (
    <main className="space-y-8">
      <section className="relative overflow-hidden rounded-[3rem] border border-ink/10 bg-slate text-white shadow-panel">
        ...
        <div className="relative grid items-center gap-8 px-6 py-8 xl:grid-cols-[1.15fr_0.85fr] xl:px-10 xl:py-10">
          <div className="space-y-8">
            <div>
              ...
              <h1 className="mt-5 max-w-4xl text-5xl font-semibold leading-[0.9] tracking-tight sm:text-6xl xl:text-7xl">
                Walk the city. Swing for the tightest circle.
              </h1>
          ...
          <div>
            <div className="rounded-[2.4rem] border border-white/12 bg-white p-6 text-ink shadow-[0_24px_80px_rgba(6,11,9,0.32)]">
              ...
              <p className="mt-3 text-sm leading-7 text-ink/62">
                One code, one shared scorecard, one clue at a time.
              </p>
              <div className="mt-5">
                <JoinGameForm />
              </div>

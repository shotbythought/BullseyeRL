...
export function JoinGameForm(props?: { defaultJoinCode?: string }) {
  ...
  return (
    <form className="space-y-4" onSubmit={handleSubmit}>
      <input
        className="w-full rounded-3xl border border-ink/10 bg-white px-5 py-4 text-base uppercase outline-none transition focus:border-moss focus:ring-4 focus:ring-moss/10"
